...
def int_from_little(hex_string): return int.from_bytes(bytes.fromhex(hex_string), 'little')


# Section A.4. ECVRF-EDWARDS25519-SHA512-Elligator2
# Three test cases taken verbatim from document

print("Test 1 ...", end='')
test_dict = dict()
SK = bytes.fromhex('9d61b19deffd5a60ba844af492ec2cc44449c5697b326919703bac031cae7f60')
test_dict['public_key'] = bytes.fromhex('d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a')
alpha_string = b''  # (the empty string)
test_dict['secret_scalar'] = int_from_little('307c83864f2833cb427a2ef1c00a013cfdff2768d980c0a3a520f006904de94f')
...
test_dict['kB'] = bytes.fromhex('c4743a22340131a2323174bfc397a6585cbe0cc521bfad09f34b11dd4bcf5936')
test_dict['U'] = bytes.fromhex('c4743a22340131a2323174bfc397a6585cbe0cc521bfad09f34b11dd4bcf5936')
test_dict['kH'] = bytes.fromhex('e309cf5272f0af2f54d9dc4a6bad6998a9d097264e17ae6fce2b25dcbdd10e8b')
...
test_dict['public_key'] = bytes.fromhex('3d4017c3e843895a92b70aa74d1b7ebc9c982ccf2ec4968cc0cd55f12af4660c')
alpha_string = bytes([0x72])  # (1 byte)
test_dict['secret_scalar'] = int_from_little('68bd9ed75882d52815a97585caf4790a7f6c6b3b7f821c5e259a24b02e502e51')
...
test_dict['kB'] = bytes.fromhex('04b1ba4d8129f0d4cec522b0fd0dff84283401df791dcc9b93a219c51cf27324')
test_dict['U'] = bytes.fromhex('04b1ba4d8129f0d4cec522b0fd0dff84283401df791dcc9b93a219c51cf27324')
test_dict['kH'] = bytes.fromhex('ca8a97ce1947d2a0aaa280f03153388fa7aa754eedfca2b4a7ad405707599ba5')
...
test_dict['public_key'] = bytes.fromhex('fc51cd8e6218a1a38da47ed00230f0580816ed13ba3303ac5deb911548908025')
alpha_string = bytes.fromhex('af82')  # (2 bytes)
test_dict['secret_scalar'] = int_from_little('909a8b755ed902849023a55b15c23d11ba4d7f4ec5c2f51b1325a181991ea95c')
...
test_dict['kB'] = bytes.fromhex('d6f8a95a4ce86812e3e50febd9d48196b3bc5d1d9fa7b6dfa33072641b45d029')
test_dict['U'] = bytes.fromhex('d6f8a95a4ce86812e3e50febd9d48196b3bc5d1d9fa7b6dfa33072641b45d029')
test_dict['kH'] = bytes.fromhex('f77cd4ce0b49b386e80c3ce404185f93bb07463600dc14c31b0a09beaff4d592')
...
# TODO
#  1. Random round-trip cases (positive and negative)
#  2. Sample for printing vectors
#  3. More line by line optimization
