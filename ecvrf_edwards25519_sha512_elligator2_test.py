...
# TODO
#  1. Alight value names with variable names
#  2. Consider whether get key is a top level API; fix bloc too
#  3. Random round-trip cases (positive and negative)
#  4. More line by line optimization
